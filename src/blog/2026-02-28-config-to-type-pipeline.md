...
The repo is at [github.com/eugenioenko/yarcl](https://github.com). Clone it, run `cd consumer && pnpm dev`, and then try adding a typo to any `useFlag`, `t()`, or `env.` call. The error shows up before you leave the line.
