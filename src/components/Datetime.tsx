  ...
  return (
    ...
    >
      <svg
        ...
        } fill-theme-base inline-block h-6 w-6 min-w-[1.375rem]`}
        aria-hidden="true"
      >
    ...
    showEditPost && (
      <>
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="icon icon-tabler icons-tabler-outline icon-tabler-edit fill-theme-base inline-block !scale-90"
            aria-hidden="true"
          >
